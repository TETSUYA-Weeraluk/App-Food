  ...
  return (
    <>
      ...
      <div
        className={
          orderVisible
            ? "text-center p-4  z-20 fixed  top-20 right-0  left-0 duration-500 flex items-center justify-center"
            : "text-center p-4  z-20 fixed  top-20 left-[100%]  duration-500 flex items-center justify-center"
        }
      >
